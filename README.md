# 🤖 CareBot – AI Health Symptom Checker

This is an Agentic AI project built using IBM watsonx.ai and Granite models as part of the IBM AICTE Virtual Internship 2025.

## 🩺 Project Overview

CareBot is an AI-powered health assistant that helps users describe their symptoms in natural language and get safe, non-diagnostic health guidance. It provides possible causes, urgency levels, home remedies, and advice on when to see a doctor — without replacing medical professionals.

## 🚀 Features

- Natural language symptom input
- Suggests possible causes (non-diagnostic)
- Urgency level estimation (mild, moderate, severe)
- Home remedies and care tips
- Multilingual support
- Retrieval-Augmented Generation (RAG) with trusted sources (e.g., Wikipedia)
...
- Students & youth
- Elderly users
- NGOs and health awareness programs
